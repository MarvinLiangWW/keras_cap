...
def kmeans(n_clusters,f_in='tiwencheck.csv',f_out='tiwenlabel.csv'):
    X, y = get_csvdata(f_in, 'Category.csv')
...
def xman_xmix_normalization(f_in='number_age_col71.csv',f_out='number_age_col71tran.csv',rows=1277,cols=74):
    f_in = open(f_in)
...
if __name__=="__main__":
    print("main")
    kmeans(5,'5_day_50_check.csv','5_day_tiwenlabel.csv')
    ...
    #            'Number_Age_1.csv', 'number_age_col1.csv')
    ...
    #
    # invoke_fun('niaoyefenxicheck.csv', '红细胞(镜检)', 'col59.csv', 'w', 'Number.csv', 'col59tran.csv', 'number_age_col58.csv','number_age_col59.csv')
    # invoke_fun('niaoyefenxicheck.csv', '白细胞(镜检)', 'col61.csv', 'w', 'Number.csv', 'col61tran.csv', 'number_age_col59.csv','number_age_col61.csv')
    # invoke_fun('niaoyefenxicheck.csv', '比重', 'col63.csv', 'w', 'Number.csv', 'col63tran.csv', 'number_age_col61.csv','number_age_col63.csv')
    # invoke_fun('niaoyefenxicheck.csv', 'PH值', 'col65.csv', 'w', 'Number.csv', 'col65tran.csv', 'number_age_col63.csv','number_age_col65.csv')
    # invoke_fun('shenghuafenxicheck.csv', '白蛋白', 'col67.csv', 'w', 'Number.csv', 'col67tran.csv', 'number_age_col65.csv','number_age_col67.csv')
    # invoke_fun('shenghuafenxicheck.csv', '丙氨酸氨基转移酶', 'col69.csv', 'w', 'Number.csv', 'col69tran.csv', 'number_age_col67.csv','number_age_col69.csv')
    # invoke_fun('shenghuafenxicheck.csv', '天门冬氨酸氨基转移酶', 'col71.csv', 'w', 'Number.csv', 'col71tran.csv', 'number_age_col69.csv','number_age_col71.csv')
