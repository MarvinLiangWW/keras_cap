...
if __name__=="__main__":
    ...
    fun('niaoyefenxicheck.csv','酮体', 'col51.csv', 'w')
    add0fun('col51.csv','Number.csv',1,'col51tran.csv','w')
    add_data_fun('col51tran.csv',1,'number_age_col49.csv','number_age_col51.csv','w')

    invoke_fun('niaoyefenxicheck.csv','潜血', 'col52.csv', 'w','Number.csv','col52tran.csv','number_age_col51.csv','number_age_col52.csv')
    invoke_fun('niaoyefenxicheck.csv','葡萄糖', 'col53.csv', 'w','Number.csv','col53tran.csv','number_age_col52.csv','number_age_col53.csv')
    invoke_fun('niaoyefenxicheck.csv','尿胆原', 'col54.csv', 'w','Number.csv','col54tran.csv','number_age_col53.csv','number_age_col54.csv')
    invoke_fun('niaoyefenxicheck.csv','胆红素', 'col55.csv', 'w','Number.csv','col55tran.csv','number_age_col54.csv','number_age_col55.csv')
    invoke_fun('niaoyefenxicheck.csv','白细胞酯酶', 'col56.csv', 'w','Number.csv','col56tran.csv','number_age_col55.csv','number_age_col56.csv')
    invoke_fun('niaoyefenxicheck.csv','尿蛋白', 'col57.csv', 'w','Number.csv','col57tran.csv','number_age_col56.csv','number_age_col57.csv')
    invoke_fun('niaoyefenxicheck.csv','亚硝酸盐', 'col58.csv', 'w','Number.csv','col58tran.csv','number_age_col57.csv','number_age_col58.csv')
